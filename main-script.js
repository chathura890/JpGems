...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('About to call generateCategories...');
    generateCategories();
    generateProducts();
    initializeSlider();
...
// Initialize slider for homepage
...
function generateCategories() {
    ...
    const categoryContainer = document.querySelector('#categoryGrid');
    ...
    const categories = [
        ...
        },
        {
            name: 'Citrines',
            image: 'images/cc.jpg',
            link: 'html/citrine.html'
        }
    ];
    
    console.log('Categories array:', categories);
    categoryContainer.innerHTML = '';
    console.log('Starting to append categories...');
    ...
    console.log('All categories generated. Total cards:', categoryContainer.children.length);
}